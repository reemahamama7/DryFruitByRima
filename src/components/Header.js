      ...
      <div className="bg-white shadow-lg">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            <img
              ...
              className="h-10"
            />
            <h1 className="text-2xl font-bold text-[#805e36]">
              Fresh Dry Fruits
            </h1>
          </div>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ...
                  : "text-gray-600 hover:text-[#805e36] transition"
              }
            >
              Home
            </NavLink>
        ...
        >
          <div className="flex justify-between items-center p-4 border-b">
            <h2 className="text-xl font-bold text-[#805e36]">
              Menu
            </h2>
          ...
          <div className="p-4 space-y-4">
            <NavLink
              to="/"
              className="block text-gray-600 hover:text-[#805e36] py-2"
              onClick={handleMenuToggle}
            >
              Home
            </NavLink>
          ...
          <div className="p-4">
            <input
              type="text"
              placeholder="Search"
              className="w-full border rounded-md px-4 py-2 text-sm mb-4"
            />

            <button
              type="button"
              className="w-full flex justify-center items-center py-2 bg-[#805e36] text-white rounded-lg hover:bg-[#6b4e2b] transition"
            >
